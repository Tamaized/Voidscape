...
@Component
public class CollectorBlockModelHolder extends BlockModelHolder {
	...
	protected DeferredHolder<Block, ? extends Block> blockForName() {
		return blocks.machineBlocks().MACHINE_COLLECTOR;
	}
	...
	public Identifier finalize(BlockModelGenerators provider, FurtherExtendedModelTemplateBuilder model) {
		return Identifier.fromNamespaceAndPath(Voidscape.MODID, "block/collector");
	}
	...
	public Optional<String> lang() {
		return Optional.of("Voidic Collector");
	}
}
