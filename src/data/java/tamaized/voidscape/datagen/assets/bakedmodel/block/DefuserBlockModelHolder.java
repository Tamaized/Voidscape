...
@Component
public class DefuserBlockModelHolder extends BlockModelHolder {
	...
	protected DeferredHolder<Block, ? extends Block> blockForName() {
		return blocks.machineBlocks().MACHINE_DEFUSER;
	}
	...
	public Identifier finalize(BlockModelGenerators provider, FurtherExtendedModelTemplateBuilder model) {
		return Identifier.fromNamespaceAndPath(Voidscape.MODID, "block/defuser");
	}
	...
	public Optional<String> lang() {
		return Optional.of("Voidic Defuser");
	}
}
