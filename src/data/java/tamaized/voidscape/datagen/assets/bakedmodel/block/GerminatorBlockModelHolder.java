...
@Component
public class GerminatorBlockModelHolder extends BlockModelHolder {
	...
	protected DeferredHolder<Block, ? extends Block> blockForName() {
		return blocks.machineBlocks().MACHINE_GERMINATOR;
	}
	...
	public Identifier finalize(BlockModelGenerators provider, FurtherExtendedModelTemplateBuilder model) {
		return Identifier.fromNamespaceAndPath(Voidscape.MODID, "block/germinator");
	}
	...
	public Optional<String> lang() {
		return Optional.of("Voidic Germinator");
	}
}
