...
public class HatcheryBlockModelHolder extends BlockModelHolder {
	...
	protected DeferredHolder<Block, ? extends Block> blockForName() {
		return blocks.machineBlocks().MACHINE_HATCHERY;
	}
	...
	protected void defineTextureSlots(ExtendedTextureMapping mapping) {
		mapping
			...
			.putForced(ModTextureSlots.TEXTURE_0, new Material(Identifier.fromNamespaceAndPath(Voidscape.MODID, "block/machine/hatchery/frame")))
