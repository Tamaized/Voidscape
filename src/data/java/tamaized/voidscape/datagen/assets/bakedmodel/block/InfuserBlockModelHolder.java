...
@Component
public class InfuserBlockModelHolder extends BlockModelHolder {
	...
	protected DeferredHolder<Block, ? extends Block> blockForName() {
		return blocks.machineBlocks().MACHINE_INFUSER;
	}
	...
	public Identifier finalize(BlockModelGenerators provider, FurtherExtendedModelTemplateBuilder model) {
		return Identifier.fromNamespaceAndPath(Voidscape.MODID, "block/infuser");
	}
	...
	public Optional<String> lang() {
		return Optional.of("Voidic Infuser");
	}
}
