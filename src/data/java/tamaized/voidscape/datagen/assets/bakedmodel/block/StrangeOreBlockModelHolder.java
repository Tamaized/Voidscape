...
public class StrangeOreBlockModelHolder extends BlockModelHolder {
	...
	protected DeferredHolder<Block, ? extends Block> blockForName() {
		return blocks.oreBlocks().STRANGE_ORE;
	}
	...
	protected void defineTextureSlots(ExtendedTextureMapping mapping) {
		mapping
			...
			.putForced(ModTextureSlots.BASE, new Material(Identifier.withDefaultNamespace("block/end_stone")))
	...
	public Optional<String> lang() {
		return Optional.of("Strange Ore");
	}
}
