...
public class ThunderPlanksBlockModelHolder extends BlockModelHolder {
	...
	protected DeferredHolder<Block, ? extends Block> blockForName() {
		return blocks.thunderForestBiomeBlocks().THUNDER_PLANKS;
	}
	...
	protected void defineTextureSlots(ExtendedTextureMapping mapping) {
		mapping
			...
			.putForced(TextureSlot.ALL, new Material(Identifier.fromNamespaceAndPath(Voidscape.MODID, name())));
	}
	...
	public Optional<String> lang() {
		return Optional.of("Thunder Planks");
	}
}
