...
public class ThunderStemBlockModelHolder extends BlockModelHolder {
	...
	protected void defineTextureSlots(ExtendedTextureMapping mapping) {
		mapping
			...
			.putForced(ModTextureSlots.END_OVERLAY, new Material(Identifier.fromNamespaceAndPath(Voidscape.MODID, name("top_overlay"))))
			.putForced(TextureSlot.SIDE, new Material(Identifier.fromNamespaceAndPath(Voidscape.MODID, name())))
			.putForced(ModTextureSlots.SIDE_OVERLAY, new Material(Identifier.fromNamespaceAndPath(Voidscape.MODID, name("overlay"))));
	}
