...
public class WellBlockModelHolder extends BlockModelHolder {
	...
	protected DeferredHolder<Block, ? extends Block> blockForName() {
		return blocks.machineBlocks().MACHINE_WELL;
	}
	...
	protected void defineTextureSlots(ExtendedTextureMapping mapping) {
		mapping
			...
			.putForced(ModTextureSlots.TEXTURE_0, new Material(Identifier.fromNamespaceAndPath(Voidscape.MODID, "block/machine/well/frame")))
	...
	public Optional<String> lang() {
		return Optional.of("Voidic Well");
	}
}
