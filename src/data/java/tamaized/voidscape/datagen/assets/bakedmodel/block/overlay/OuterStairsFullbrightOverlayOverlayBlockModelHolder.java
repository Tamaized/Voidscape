...
@Component
public class OuterStairsFullbrightOverlayOverlayBlockModelHolder extends BlockModelHolder {
		...
		return model
			.buildExtended(m -> m
				...
				.element(e -> e
					...
					.face(Direction.UP, f -> f.uvs(8, 8, 16, 16).texture(TextureSlot.TOP).cullface(Direction.UP))
					.face(Direction.NORTH, f -> f.uvs(0, 0, 8, 8).texture(TextureSlot.SIDE))
					.face(Direction.SOUTH, f -> f.uvs(8, 0, 16, 8).texture(TextureSlot.SIDE).cullface(Direction.SOUTH))
					.face(Direction.WEST, f -> f.uvs(8, 0, 16, 8).texture(TextureSlot.SIDE))
					.face(Direction.EAST, f -> f.uvs(0, 0, 8, 8).texture(TextureSlot.SIDE).cullface(Direction.EAST)))
				.element(e -> e
					.from(0, 0, 0).to(16, 8, 16)
				...
				.element(e -> e
					.from(8, 8, 8).to(16, 16, 16)
					.face(Direction.UP, f -> f.uvs(8, 8, 16, 16).texture(ModTextureSlots.OVERLAY_TOP).lightEmission(15).cullface(Direction.UP))
					.face(Direction.NORTH, f -> f.uvs(0, 0, 8, 8).texture(ModTextureSlots.OVERLAY_SIDE).lightEmission(15))
					.face(Direction.SOUTH, f -> f.uvs(8, 0, 16, 8).texture(ModTextureSlots.OVERLAY_SIDE).lightEmission(15).cullface(Direction.SOUTH))
					.face(Direction.WEST, f -> f.uvs(8, 0, 16, 8).texture(ModTextureSlots.OVERLAY_SIDE).lightEmission(15))
					.face(Direction.EAST, f -> f.uvs(0, 0, 8, 8).texture(ModTextureSlots.OVERLAY_SIDE).lightEmission(15).cullface(Direction.EAST))))
			.create(Identifier.fromNamespaceAndPath(Voidscape.MODID, "block/overlay/outer_stairs_fullbright_overlay"), textures(), provider.modelOutput);
	}
