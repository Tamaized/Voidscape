...
@Component
public class AstralEssenceItemModelHolder extends ItemModelHolder {
	...
	protected @Nullable DeferredHolder<Item, ? extends Item> itemForName() {
		return items.materialItems().ASTRAL_ESSENCE;
	}
	...
	public ModelFile build(ItemModelProvider provider) {
		return provider.withExistingParent(name(), "item/generated")
			...
			.texture("layer0", "item/astral_essence");
	}

	@Override
	public Optional<String> lang() {
		return Optional.of("Astral Essence");
	}
}
