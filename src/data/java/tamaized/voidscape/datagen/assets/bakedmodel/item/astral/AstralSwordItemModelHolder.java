...
@Component
public class AstralSwordItemModelHolder extends BreakableFullbrightItemModelHolder {
	...
	protected DeferredHolder<Item, ? extends Item> itemForName() {
		return tools.astralToolSet().ASTRAL_SWORD;
	}
	...
	protected String texturePath() {
		return "item/astral/sword";
	}

	@Override
	public Optional<String> lang() {
		return Optional.of("Astral Sword");
	}
}
