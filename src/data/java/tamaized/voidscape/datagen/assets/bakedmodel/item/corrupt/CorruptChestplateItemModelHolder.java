...
@Component
public class CorruptChestplateItemModelHolder extends BreakableFullbrightItemModelHolder {
	...
	protected String texturePath() {
		return "item/corrupt/chest";
	}

	@Override
	public Optional<String> lang() {
		return Optional.of("Corrupt Chestplate");
	}
}
