...
@Component
public class CorruptSwordItemModelHolder extends ItemModelHolder {
	...
	protected DeferredHolder<Item, ? extends Item> itemForName() {
		return tools.corruptToolSet().CORRUPT_SWORD;
	}
	...
	public ModelFile build(ItemModelProvider provider) {
		...
		return provider.withExistingParent(
			...
			.texture("layer0", "item/corrupt/sword")
	...
	private ModelFile getBrokenModel(ItemModelProvider provider) {
		if (brokenModel == null) {
			brokenModel = provider.withExistingParent(
				...
				.texture("layer0", "item/corrupt/sword_broken")
				.customLoader(ItemLayerModelBuilder::begin).emissive(15, 15, 0).end();
		}
		return brokenModel;
	}
	...
	public Optional<String> lang() {
		return Optional.of("Corrupt Sword");
	}
