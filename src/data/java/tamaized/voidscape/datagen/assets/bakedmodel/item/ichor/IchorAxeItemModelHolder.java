...
@Component
public class IchorAxeItemModelHolder extends BreakableFullbrightItemModelHolder {
	...
	protected DeferredHolder<Item, ? extends Item> itemForName() {
		return tools.ichorToolSet().ICHOR_AXE;
	}
	...
	protected String texturePath() {
		return "item/ichor/axe";
	}

	@Override
	public Optional<String> lang() {
		return Optional.of("Ichor Axe");
	}
}
