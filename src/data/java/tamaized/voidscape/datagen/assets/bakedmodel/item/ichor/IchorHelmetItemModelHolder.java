...
@Component
public class IchorHelmetItemModelHolder extends ItemModelHolder {
	...
	protected DeferredHolder<Item, ? extends Item> itemForName() {
		return armor.ichorArmorSet().ICHOR_HELMET;
	}

	@Override
	public Optional<String> lang() {
		return Optional.of("Ichor Helmet");
	}
	...
	public ModelFile build(ItemModelProvider provider) {
		...
		return provider.withExistingParent(
			...
			.texture("layer0", "item/ichor/helmet")
	...
	public ModelFile getBrokenModel(ItemModelProvider provider) {
		if (brokenModel == null) {
			brokenModel = provider.withExistingParent(
				...
				.texture("layer0", "item/ichor/helmet_broken")
				.customLoader(ItemLayerModelBuilder::begin).emissive(15, 15, 0).end();
		}
		return brokenModel;
	}
