...
@Component
public class ShroudLeggingsItemModelHolder extends BreakableFullbrightItemModelHolder {
	...
	protected DeferredHolder<Item, ? extends Item> itemForName() {
		return armor.shroudArmorSet().SHROUD_LEGS;
	}

	@Override
	protected String texturePath() {
		return "item/shroud/legs";
	}

	@Override
	public Optional<String> lang() {
		return Optional.of("Shroud Leggings");
	}
}
