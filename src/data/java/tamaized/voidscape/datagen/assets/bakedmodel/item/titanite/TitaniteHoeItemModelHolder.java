...
@Component
public class TitaniteHoeItemModelHolder extends BreakableFullbrightItemModelHolder {
	...
	protected DeferredHolder<Item, ? extends Item> itemForName() {
		return tools.titaniteToolSet().TITANITE_HOE;
	}
	...
	protected String texturePath() {
		return "item/titanite/hoe";
	}

	@Override
	public Optional<String> lang() {
		return Optional.of("Titanite Hoe");
	}
}
