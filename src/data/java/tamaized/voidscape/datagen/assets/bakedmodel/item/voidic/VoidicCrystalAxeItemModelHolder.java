...
@Component
public class VoidicCrystalAxeItemModelHolder extends BreakableFullbrightItemModelHolder {
	...
	protected DeferredHolder<Item, ? extends Item> itemForName() {
		return tools.voidicCrystalToolSet().VOIDIC_CRYSTAL_AXE;
	}
	...
	protected String texturePath() {
		return "item/voidic/axe";
	}

	@Override
	public Optional<String> lang() {
		return Optional.of("Voidic Crystal Axe");
	}
}
