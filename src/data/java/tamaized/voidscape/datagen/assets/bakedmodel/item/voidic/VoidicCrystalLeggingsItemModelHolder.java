...
@Component
public class VoidicCrystalLeggingsItemModelHolder extends BreakableFullbrightItemModelHolder {
	...
	protected String texturePath() {
		return "item/voidic/legs";
	}

	@Override
	public Optional<String> lang() {
		return Optional.of("Voidic Crystal Leggings");
	}
}
