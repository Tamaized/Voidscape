...
@Component
public class VoidicCrystalPickaxeItemModelHolder extends BreakableFullbrightItemModelHolder {
	...
	protected DeferredHolder<Item, ? extends Item> itemForName() {
		return tools.voidicCrystalToolSet().VOIDIC_CRYSTAL_PICKAXE;
	}
	...
	protected String texturePath() {
		return "item/voidic/pickaxe";
	}

	@Override
	public Optional<String> lang() {
		return Optional.of("Voidic Crystal Pickaxe");
	}
}
