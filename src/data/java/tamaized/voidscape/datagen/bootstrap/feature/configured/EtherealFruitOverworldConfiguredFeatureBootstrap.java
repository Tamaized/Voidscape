...
@Component
public class EtherealFruitOverworldConfiguredFeatureBootstrap extends ConfiguredFeatureBootstrapHolder {
	...
	@Override
	public String name() {
		return "ethereal_fruit_overworld";
	}
		...
		return new ConfiguredFeature<>(Feature.RANDOM_PATCH, new RandomPatchConfiguration(
			...
			Holder.direct(new PlacedFeature(
				Holder.direct(new ConfiguredFeature<>(
					...
					new SimpleBlockConfiguration(BlockStateProvider.simple(blocks.etherealFruitBlocks().OVERWORLD.get()))
				)),
				List.of(
