...
import tamaized.voidscape.datagen.bootstrap.feature.configured.AmethystConfiguredFeatureBootstrap;
import tamaized.voidscape.features.placements.RandomYPlacementMod;

import java.util.List;

@Component
public class AmethystPlacedFeatureBootstrap extends PlacedFeatureBootstrapHolder {

	@Autowired
	private AmethystConfiguredFeatureBootstrap parentFeature;
