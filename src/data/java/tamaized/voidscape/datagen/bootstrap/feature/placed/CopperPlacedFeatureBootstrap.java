...
import tamaized.voidscape.datagen.bootstrap.feature.configured.CopperConfiguredFeatureBootstrap;
import tamaized.voidscape.features.placements.RandomYPlacementMod;

import java.util.List;

@Component
public class CopperPlacedFeatureBootstrap extends PlacedFeatureBootstrapHolder {

	@Autowired
	private CopperConfiguredFeatureBootstrap parentFeature;
