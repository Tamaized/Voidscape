...
import tamaized.voidscape.datagen.bootstrap.feature.configured.EtherealFruitEndConfiguredFeatureBootstrap;
...
@Component
public class EtherealFruitEndPatchPlacedFeatureBootstrap extends PlacedFeatureBootstrapHolder {

	@Autowired
	private EtherealFruitEndConfiguredFeatureBootstrap parentFeature;
	...
	@Override
	public String name() {
		return "ethereal_fruit_end_patch";
	}
