...
import tamaized.voidscape.datagen.bootstrap.feature.configured.EtherealFruitNetherConfiguredFeatureBootstrap;
...
@Component
public class EtherealFruitNetherPatchPlacedFeatureBootstrap extends PlacedFeatureBootstrapHolder {

	@Autowired
	private EtherealFruitNetherConfiguredFeatureBootstrap parentFeature;
	...
	@Override
	public String name() {
		return "ethereal_fruit_nether_patch";
	}
