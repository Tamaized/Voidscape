...
import tamaized.voidscape.datagen.bootstrap.feature.configured.EtherealFruitOverworldConfiguredFeatureBootstrap;
...
@Component
public class EtherealFruitOverworldPatchPlacedFeatureBootstrap extends PlacedFeatureBootstrapHolder {

	@Autowired
	private EtherealFruitOverworldConfiguredFeatureBootstrap parentFeature;
	...
	@Override
	public String name() {
		return "ethereal_fruit_overworld_patch";
	}
