...
@Component
public class ShroudTowerStructureBootstrap extends StructureBootstrapHolder {
	...
	public Structure make(BootstrapContext<Structure> context) {
		return new ShroudTowerStructure(new Structure.StructureSettings.Builder(HolderSet.direct(
