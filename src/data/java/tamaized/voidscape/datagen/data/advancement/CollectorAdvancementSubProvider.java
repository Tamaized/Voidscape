...
@Component
public class CollectorAdvancementSubProvider extends AbstractAdvancementSubProvider {
	...
	public AdvancementHolder make(HolderLookup.Provider registries, Consumer<AdvancementHolder> saver, ExistingFileHelper existingFileHelper) {
		return Advancement.Builder.advancement()
			...
			.display(
				blocks.machineBlocks().MACHINE_COLLECTOR_ITEM.get(),
				title(),
				description(),
				null,
			...
			.addCriterion("collector", advancementTriggers.COLLECTOR_TRIGGER.get().createCriterion(
