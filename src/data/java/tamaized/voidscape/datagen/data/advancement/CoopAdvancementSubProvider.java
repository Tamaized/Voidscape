...
@Component
public class CoopAdvancementSubProvider extends AbstractAdvancementSubProvider {
	...
	public AdvancementHolder make(HolderLookup.Provider registries, Consumer<AdvancementHolder> saver, ExistingFileHelper existingFileHelper) {
		return Advancement.Builder.advancement()
			...
			.display(
				blocks.machineBlocks().MACHINE_COOP_ITEM.get(),
				title(),
				description(),
				null,
			...
			.addCriterion("coop", advancementTriggers.COOP_TRIGGER.get().createCriterion(
