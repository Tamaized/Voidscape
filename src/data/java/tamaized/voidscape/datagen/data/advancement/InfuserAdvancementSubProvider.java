...
@Component
public class InfuserAdvancementSubProvider extends AbstractAdvancementSubProvider {
	...
	public AdvancementHolder make(HolderLookup.Provider registries, Consumer<AdvancementHolder> saver, ExistingFileHelper existingFileHelper) {
		return Advancement.Builder.advancement()
			...
			.display(
				blocks.machineBlocks().MACHINE_INFUSER_ITEM.get(),
				title(),
				description(),
				null,
			...
			.addCriterion("infuser", advancementTriggers.INFUSER_TRIGGER.get().createCriterion(
