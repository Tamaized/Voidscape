...
@Component
public class PortalAdvancementSubProvider extends AbstractAdvancementSubProvider {
	...
	public AdvancementHolder make(HolderLookup.Provider registries, Consumer<AdvancementHolder> saver) {
		return Advancement.Builder.advancement()
			...
			.display(
				blocks.materialBlocks().VOIDIC_CRYSTAL_BLOCK_ITEM.get(),
				title(),
				description(),
				null,
			...
			.addCriterion("portal", advancementTriggers.ACTIVATE_PORTAL_TRIGGER.get().createCriterion(
