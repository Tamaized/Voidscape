...
@Component
public class SpiderEggsAdvancementSubProvider extends AbstractAdvancementSubProvider {
	...
	public AdvancementHolder make(HolderLookup.Provider registries, Consumer<AdvancementHolder> saver, ExistingFileHelper existingFileHelper) {
		return Advancement.Builder.advancement()
			...
			.display(
				items.miscItems().ETHEREAL_SPIDER_EGGS.get(),
				title(),
				description(),
				null,
			...
			.addCriterion("spidereggs", advancementTriggers.ETHEREAL_SPIDER_EGGS_TRIGGER.get().createCriterion(
