...
@Component
public class WellAdvancementSubProvider extends AbstractAdvancementSubProvider {

	@Autowired
	private GerminatedAdvancementSubProvider parent;
	...
	public AdvancementHolder make(HolderLookup.Provider registries, Consumer<AdvancementHolder> saver, ExistingFileHelper existingFileHelper) {
		return Advancement.Builder.advancement()
			...
			.display(
				blocks.machineBlocks().MACHINE_WELL_ITEM.get(),
				title(),
				description(),
				null,
			...
			.addCriterion("well", advancementTriggers.WELL_TRIGGER.get().createCriterion(
