...
@Component
public class AstralAxeFangRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		ItemStack result = new ItemStack(items.toolSetComponentDirectory().astralToolSet().ASTRAL_AXE.get());
		...
		ExtendedSmithingTransformRecipeBuilder.extendedSmithing(
			...
			Ingredient.of(items.toolSetComponentDirectory().astralToolSet().ASTRAL_AXE.get()),
			...
			.save(recipeOutput, "astral_axe_fang");
	}
