...
@Component
public class AstralBowFangRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		ItemStack result = new ItemStack(items.toolSetComponentDirectory().astralToolSet().ASTRAL_BOW.get());
		...
		ExtendedSmithingTransformRecipeBuilder.extendedSmithing(
			...
			Ingredient.of(items.toolSetComponentDirectory().astralToolSet().ASTRAL_BOW.get()),
			...
			.save(recipeOutput, "astral_bow_fang");
	}
