...
@Component
public class AstralLeggingsRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		SmithingTransformRecipeBuilder.smithing(
			...
			Ingredient.of(items.modArmorSetComponentDirectory().ichorArmorSet().ICHOR_LEGS.get()),
			...
			.save(recipeOutput, "astral_leggings");
	}
