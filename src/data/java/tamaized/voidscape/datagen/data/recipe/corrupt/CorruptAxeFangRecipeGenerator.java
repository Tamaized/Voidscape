...
@Component
public class CorruptAxeFangRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		ItemStack result = new ItemStack(items.toolSetComponentDirectory().corruptToolSet().CORRUPT_AXE.get());
		...
		ExtendedSmithingTransformRecipeBuilder.extendedSmithing(
			...
			Ingredient.of(items.toolSetComponentDirectory().corruptToolSet().CORRUPT_AXE.get()),
			...
			.save(recipeOutput, "corrupt_axe_fang");
	}
