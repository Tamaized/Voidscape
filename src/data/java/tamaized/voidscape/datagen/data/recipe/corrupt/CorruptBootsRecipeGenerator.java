...
@Component
public class CorruptBootsRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		SmithingTransformRecipeBuilder.smithing(
			...
			Ingredient.of(items.modArmorSetComponentDirectory().voidicCrystalArmorSet().VOIDIC_CRYSTAL_BOOTS.get()),
			...
			.save(recipeOutput, "corrupt_boots");
	}
