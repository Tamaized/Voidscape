...
@Component
public class CorruptBowFangRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		ItemStack result = new ItemStack(items.toolSetComponentDirectory().corruptToolSet().CORRUPT_BOW.get());
		...
		ExtendedSmithingTransformRecipeBuilder.extendedSmithing(
			...
			.save(recipeOutput, "corrupt_bow_fang");
	}
