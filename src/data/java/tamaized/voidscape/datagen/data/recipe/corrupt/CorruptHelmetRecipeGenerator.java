...
@Component
public class CorruptHelmetRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		SmithingTransformRecipeBuilder.smithing(
			...
			Ingredient.of(items.modArmorSetComponentDirectory().voidicCrystalArmorSet().VOIDIC_CRYSTAL_HELMET.get()),
			...
			.save(recipeOutput, "corrupt_helmet");
	}
