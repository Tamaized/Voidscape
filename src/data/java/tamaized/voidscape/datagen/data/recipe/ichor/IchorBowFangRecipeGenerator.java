...
@Component
public class IchorBowFangRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		ItemStack result = new ItemStack(items.toolSetComponentDirectory().ichorToolSet().ICHOR_BOW.get());
		...
		ExtendedSmithingTransformRecipeBuilder.extendedSmithing(
			...
			.save(recipeOutput, "ichor_bow_fang");
	}
