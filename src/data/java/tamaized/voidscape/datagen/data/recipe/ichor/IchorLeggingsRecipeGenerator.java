...
@Component
public class IchorLeggingsRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		SmithingTransformRecipeBuilder.smithing(
			...
			Ingredient.of(items.modArmorSetComponentDirectory().titaniteArmorSet().TITANITE_LEGS.get()),
			...
			.save(recipeOutput, "ichor_leggings");
	}
