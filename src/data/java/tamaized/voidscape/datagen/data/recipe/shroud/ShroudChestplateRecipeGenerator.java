...
@Component
public class ShroudChestplateRecipeGenerator extends RecipeHolder {
	...
	public void make(HolderLookup.Provider provider, HolderGetter<Item> itemProvider, RecipeOutput recipeOutput) {
		SmithingTransformRecipeBuilder.smithing(
			...
			Ingredient.of(items.materialItems().SHROUD_THREAD.get()),
			...
			.save(recipeOutput, "shroud_chestplate");
	}
