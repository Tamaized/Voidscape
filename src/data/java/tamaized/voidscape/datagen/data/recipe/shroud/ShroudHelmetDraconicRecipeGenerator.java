...
@Component
public class ShroudHelmetDraconicRecipeGenerator extends RecipeHolder {
	...
	public void make(HolderLookup.Provider provider, HolderGetter<Item> itemProvider, RecipeOutput recipeOutput) {
		...
		new SmithingTransformRecipeBuilder(
			...
			Ingredient.of(items.modArmorSetComponentDirectory().shroudArmorSet().SHROUD_HELMET.get()),
			...
			.save(recipeOutput, "shroud_helmet_draconic");
	}
