...
@Component
public class ShroudLeggingsDraconicRecipeGenerator extends RecipeHolder {
	...
	public void make(HolderLookup.Provider provider, HolderGetter<Item> itemProvider, RecipeOutput recipeOutput) {
		...
		new SmithingTransformRecipeBuilder(
			...
			Ingredient.of(items.modArmorSetComponentDirectory().shroudArmorSet().SHROUD_LEGS.get()),
			...
			.save(recipeOutput, "shroud_leggings_draconic");
	}
