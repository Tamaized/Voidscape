...
@Component
public class TitaniteAxeFangRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		ItemStack result = new ItemStack(items.toolSetComponentDirectory().titaniteToolSet().TITANITE_AXE.get());
		...
		ExtendedSmithingTransformRecipeBuilder.extendedSmithing(
			...
			Ingredient.of(items.toolSetComponentDirectory().titaniteToolSet().TITANITE_AXE.get()),
			...
			.save(recipeOutput, "titanite_axe_fang");
	}
