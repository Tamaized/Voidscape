...
@Component
public class TitaniteCrossbowFangRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		ItemStack result = new ItemStack(items.toolSetComponentDirectory().titaniteToolSet().TITANITE_XBOW.get());
		...
		ExtendedSmithingTransformRecipeBuilder.extendedSmithing(
			...
			Ingredient.of(items.toolSetComponentDirectory().titaniteToolSet().TITANITE_XBOW.get()),
			...
			.save(recipeOutput, "titanite_crossbow_fang");
	}
