...
@Component
public class TitaniteHelmetRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		SmithingTransformRecipeBuilder.smithing(
			...
			Ingredient.of(items.modArmorSetComponentDirectory().corruptArmorSet().CORRUPT_HELMET.get()),
			...
			.save(recipeOutput, "titanite_helmet");
	}
