...
@Component
public class TitaniteLeggingsRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		SmithingTransformRecipeBuilder.smithing(
			...
			Ingredient.of(items.modArmorSetComponentDirectory().corruptArmorSet().CORRUPT_LEGS.get()),
			...
			.save(recipeOutput, "titanite_leggings");
	}
