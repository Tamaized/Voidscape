...
@Component
public class TitaniteSwordFangRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		ItemStack result = new ItemStack(items.toolSetComponentDirectory().titaniteToolSet().TITANITE_SWORD.get());
		...
		ExtendedSmithingTransformRecipeBuilder.extendedSmithing(
			...
			Ingredient.of(items.toolSetComponentDirectory().titaniteToolSet().TITANITE_SWORD.get()),
			...
			.save(recipeOutput, "titanite_sword_fang");
	}
