...
@Component
public class VoidicAxeFangRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		ItemStack result = new ItemStack(items.toolSetComponentDirectory().voidicCrystalToolSet().VOIDIC_CRYSTAL_AXE.get());
		...
		ExtendedSmithingTransformRecipeBuilder.extendedSmithing(
			...
			Ingredient.of(items.toolSetComponentDirectory().voidicCrystalToolSet().VOIDIC_CRYSTAL_AXE.get()),
			...
			.save(recipeOutput, "voidic_crystal_axe_fang");
	}
