...
@Component
public class VoidicBowFangRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		ItemStack result = new ItemStack(items.toolSetComponentDirectory().voidicCrystalToolSet().VOIDIC_CRYSTAL_BOW.get());
		...
		ExtendedSmithingTransformRecipeBuilder.extendedSmithing(
			...
			Ingredient.of(items.toolSetComponentDirectory().voidicCrystalToolSet().VOIDIC_CRYSTAL_BOW.get()),
			...
			.save(recipeOutput, "voidic_crystal_bow_fang");
	}
