...
@Component
public class VoidicCrossbowFangRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		ItemStack result = new ItemStack(items.toolSetComponentDirectory().voidicCrystalToolSet().VOIDIC_CRYSTAL_XBOW.get());
		...
		ExtendedSmithingTransformRecipeBuilder.extendedSmithing(
			...
			.save(recipeOutput, "voidic_crystal_crossbow_fang");
	}
