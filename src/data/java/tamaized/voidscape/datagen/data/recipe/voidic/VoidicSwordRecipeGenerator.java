...
@Component
public class VoidicSwordRecipeGenerator implements IRecipeGenerator {
	...
	public void generate(RecipeOutput recipeOutput) {
		SmithingTransformRecipeBuilder.smithing(
			...
			items.toolSetComponentDirectory().voidicCrystalToolSet().VOIDIC_CRYSTAL_SWORD.get()
		)
			.unlocks("has_template", recipeProviderUtil.has(items.augmentItems().VOIDIC_TEMPLATE.get()))
			.save(recipeOutput, "voidic_crystal_sword");
	}
