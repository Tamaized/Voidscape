...
@Component
public class BypassesResistanceDamageTypeTagProviderFactory implements IDamageTypeTagProviderFactory {
	...
	public void make(DamageTypeTagProviderFactory.DamageTypeTagsProviderAccessor accessor, HolderLookup.Provider provider) {
		accessor.tag(DamageTypeTags.BYPASSES_RESISTANCE).add(
			damageSource.VOIDIC
		);
	}
}
