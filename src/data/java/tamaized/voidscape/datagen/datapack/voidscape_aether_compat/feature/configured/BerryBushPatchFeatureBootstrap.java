...
@Component
public class BerryBushPatchFeatureBootstrap extends PlacedFeatureBootstrapHolder {
	...
	@Override
	public String name() {
		return "berry_bush_patch";
	}

	@Override
	public PlacedFeature make(BootstrapContext<PlacedFeature> context) {
		return new PlacedFeature(
			DirectReferenceHolder.of(AetherConfiguredFeatures.BERRY_BUSH_PATCH_CONFIGURATION),
			List.of(
				CountPlacement.of(6),
