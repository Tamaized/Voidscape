...
@Component
public class GravititeOreFeatureBootstrap extends PlacedFeatureBootstrapHolder {

	@Override
	public String name() {
		return "gravitite_ore";
	}

	@Override
	public PlacedFeature make(BootstrapContext<PlacedFeature> context) {
		return new PlacedFeature(
			DirectReferenceHolder.of(AetherConfiguredFeatures.ORE_GRAVITITE_CONFIGURATION),
			List.of(
				CountPlacement.of(2),
