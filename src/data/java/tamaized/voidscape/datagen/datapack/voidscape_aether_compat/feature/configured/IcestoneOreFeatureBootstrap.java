...
@Component
public class IcestoneOreFeatureBootstrap extends PlacedFeatureBootstrapHolder {
	...
	public PlacedFeature make(BootstrapContext<PlacedFeature> context) {
		return new PlacedFeature(
			DirectReferenceHolder.of(AetherConfiguredFeatures.ORE_ICESTONE_CONFIGURATION),
			List.of(
				CountPlacement.of(2),
