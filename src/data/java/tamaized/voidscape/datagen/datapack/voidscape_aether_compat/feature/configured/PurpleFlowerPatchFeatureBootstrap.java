...
@Component
public class PurpleFlowerPatchFeatureBootstrap extends PlacedFeatureBootstrapHolder {
	...
	@Override
	public String name() {
		return "purple_flower_patch";
	}

	@Override
	public PlacedFeature make(BootstrapContext<PlacedFeature> context) {
		return new PlacedFeature(
			DirectReferenceHolder.of(AetherConfiguredFeatures.PURPLE_FLOWER_PATCH_CONFIGURATION),
			List.of(
				CountPlacement.of(6),
