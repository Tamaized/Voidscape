	...
	public static void init(IEventBus bus) {
		bus.addListener(RegisterShadersEvent.class, event -> {
			try {
				...
				event.registerShader(new AlphaShaderInstance(event.getResourceProvider(), new ResourceLocation(Voidscape.MODID, "alpha/pos_tex_color"), DefaultVertexFormat.
						POSITION_TEX_COLOR), shader -> ALPHA_POS_TEX_COLOR = (AlphaShaderInstance) shader);
				event.registerShader(new OptimalAlphaShaderInstance(event.getResourceProvider(), new ResourceLocation(Voidscape.MODID, "optimal_alpha/lessthan/pos_color"), DefaultVertexFormat.
						POSITION_COLOR), shader -> OPTIMAL_ALPHA_LESSTHAN_POS_COLOR = (OptimalAlphaShaderInstance) shader);
				event.registerShader(new OptimalAlphaShaderInstance(event.getResourceProvider(), new ResourceLocation(Voidscape.MODID, "optimal_alpha/lessthan/pos_tex_color"), DefaultVertexFormat.
						POSITION_TEX_COLOR), shader -> OPTIMAL_ALPHA_LESSTHAN_POS_TEX_COLOR = (OptimalAlphaShaderInstance) shader);
				event.registerShader(new OptimalAlphaShaderInstance(event.getResourceProvider(), new ResourceLocation(Voidscape.MODID, "optimal_alpha/greaterthan/pos_color"), DefaultVertexFormat.
						POSITION_COLOR), shader -> OPTIMAL_ALPHA_GREATERTHAN_POS_COLOR = (OptimalAlphaShaderInstance) shader);
				event.registerShader(new OptimalAlphaShaderInstance(event.getResourceProvider(), new ResourceLocation(Voidscape.MODID, "optimal_alpha/greaterthan/pos_tex"), DefaultVertexFormat.
						POSITION_TEX), shader -> OPTIMAL_ALPHA_GREATERTHAN_POS_TEX = (OptimalAlphaShaderInstance) shader);
				event.registerShader(new OptimalAlphaShaderInstance(event.getResourceProvider(), new ResourceLocation(Voidscape.MODID, "optimal_alpha/greaterthan/pos_tex_color"), DefaultVertexFormat.
						POSITION_TEX_COLOR), shader -> OPTIMAL_ALPHA_GREATERTHAN_POS_TEX_COLOR = (OptimalAlphaShaderInstance) shader);
				event.registerShader(new BindableShaderInstance(event.getResourceProvider(), new ResourceLocation(Voidscape.MODID, "voidsky/sky"), DefaultVertexFormat.
						POSITION), shader -> VOIDSKY = (BindableShaderInstance) shader);
				event.registerShader(new BindableShaderInstance(event.getResourceProvider(), new ResourceLocation(Voidscape.MODID, "voidsky/entity"), DefaultVertexFormat.
						NEW_ENTITY), shader -> VOIDSKY_ENTITY = (BindableShaderInstance) shader);
				event.registerShader(new BindableShaderInstance(event.getResourceProvider(), new ResourceLocation(Voidscape.MODID, "voidsky/wings"), DefaultVertexFormat.
						POSITION_TEX), shader -> VOIDSKY_WINGS = (BindableShaderInstance) shader);
				event.registerShader(new BindableShaderInstance(event.getResourceProvider(), new ResourceLocation(Voidscape.MODID, "lines/lines"), DefaultVertexFormat.
