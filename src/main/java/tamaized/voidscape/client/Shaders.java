	...
	public static void init() {
		FMLJavaModLoadingContext.get().getModEventBus().addListener((Consumer<RegisterShadersEvent>) event -> {
			try {
				...
				event.registerShader(new AlphaShaderInstance(event.getResourceManager(), new ResourceLocation(Voidscape.MODID, "optimal_alpha/lessthan/pos_color"), DefaultVertexFormat.
						POSITION_COLOR), shader -> OPTIMAL_ALPHA_LESSTHAN_POS_COLOR = (OptimalAlphaShaderInstance) shader);
				event.registerShader(new AlphaShaderInstance(event.getResourceManager(), new ResourceLocation(Voidscape.MODID, "optimal_alpha/lessthan/pos_tex_color"), DefaultVertexFormat.
						POSITION_TEX_COLOR), shader -> OPTIMAL_ALPHA_LESSTHAN_POS_TEX_COLOR = (OptimalAlphaShaderInstance) shader);
				event.registerShader(new AlphaShaderInstance(event.getResourceManager(), new ResourceLocation(Voidscape.MODID, "optimal_alpha/greaterthan/pos_color"), DefaultVertexFormat.
						POSITION_COLOR), shader -> OPTIMAL_ALPHA_GREATERTHAN_POS_COLOR = (OptimalAlphaShaderInstance) shader);
				event.registerShader(new AlphaShaderInstance(event.getResourceManager(), new ResourceLocation(Voidscape.MODID, "optimal_alpha/greaterthan/pos_tex"), DefaultVertexFormat.
						POSITION_TEX), shader -> OPTIMAL_ALPHA_GREATERTHAN_POS_TEX = (OptimalAlphaShaderInstance) shader);
				event.registerShader(new AlphaShaderInstance(event.getResourceManager(), new ResourceLocation(Voidscape.MODID, "optimal_alpha/greaterthan/pos_tex_color"), DefaultVertexFormat.
