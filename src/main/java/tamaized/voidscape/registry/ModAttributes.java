...
public class ModAttributes implements RegistryClass {
	...
	public static final RegistryObject<RegUtil.ModAttribute> VOIDIC_PARANOIA_RES = make("voidic_paranoia_res", 1F, "Voidic Paranoia Resistance", UUID.fromString("c265b4c7-78b8-4a1b-b99b-c2a6c2af4f57"), true);
