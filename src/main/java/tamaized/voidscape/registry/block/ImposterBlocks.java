...
public class ImposterBlocks {
	...
	public final DeferredHolder<Item, Item> FRAGILE_VOIDIC_CRYSTAL_BLOCK_ITEM = REGISTRY_ITEM.register(FRAGILE_VOIDIC_CRYSTAL_BLOCK.getId().getPath(), () -> new BlockItem(
