...
public class EtherealFruitItems {
	...
	public final DeferredHolder<Item, Item> ETHEREAL_FRUIT_VOID = REGISTRY.register("ethereal_fruit_void", () -> new EtherealFruitItem(
		entity -> entity.getData(dataAttachments.INSANITY).addInfusion(150, entity),
		itemProperties.ETHEREAL_FRUIT.get()
	));

	public final DeferredHolder<Item, Item> ETHEREAL_FRUIT_NULL = REGISTRY.register("ethereal_fruit_null", () -> new EtherealFruitItem(
		entity -> entity.getData(dataAttachments.INSANITY).removeInfusion(150),
		itemProperties.ETHEREAL_FRUIT.get()
	));

	public final DeferredHolder<Item, Item> ETHEREAL_FRUIT_OVERWORLD = REGISTRY.register("ethereal_fruit_overworld", () -> new EtherealFruitItem(
		entity -> entity.getData(dataAttachments.INSANITY).removeParanoia(150),
		itemProperties.ETHEREAL_FRUIT.get()
	));

	public final DeferredHolder<Item, Item> ETHEREAL_FRUIT_NETHER = REGISTRY.register("ethereal_fruit_nether", () -> new EtherealFruitItem(
		entity -> entity.getData(dataAttachments.INSANITY).addParanoia(150),
		itemProperties.ETHEREAL_FRUIT.get()
	));

	public final DeferredHolder<Item, Item> ETHEREAL_FRUIT_END = REGISTRY.register("ethereal_fruit_end", () -> new EtherealFruitItem(
