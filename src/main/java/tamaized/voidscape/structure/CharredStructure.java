...
public class CharredStructure extends AnchoredStructure {
	...
	public CharredStructure(Structure.StructureSettings settings) {
		super(settings);
	}
	...
	@Override
	protected void generatePieces(StructurePiecesBuilder piecesBuilder, BlockPos pos, Rotation rotation, Structure.GenerationContext context) {
	...
	public static class Pieces {
		...
		public static class Piece extends TemplateStructurePiece {
			...
			public Piece(StructureTemplateManager manager, CompoundTag tag) {
				super(structurePieces.CHARRED_MAIN.get(), tag, manager, (_) -> makeSettings(Rotation.valueOf(tag.getStringOr("Rot", "none"))));
			}
