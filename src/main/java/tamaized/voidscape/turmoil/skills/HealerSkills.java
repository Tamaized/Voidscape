...
public class HealerSkills implements ITurmoilSkills {
	...
	public final TurmoilSkill SPELLPOWER_2 = generic("spellpower_2").required(SPELLPOWER_1).stats(stats -> stats.spellpower(5)).build();
	public final TurmoilSkill SPELLPOWER_3 = generic("spellpower_3").required(SPELLPOWER_2).stats(stats -> stats.spellpower(5)).build();
	public final TurmoilSkill SPELLPOWER_4 = generic("spellpower_4").required(SPELLPOWER_3).stats(stats -> stats.spellpower(10)).build();
	public final TurmoilSkill SPELLPOWER_5 = generic("spellpower_5").required(SPELLPOWER_4).stats(stats -> stats.spellpower(20)).build();
