...
public class MageSkills implements ITurmoilSkills {
	...
	public final TurmoilSkill CORE = builder("core").noDescription().core(TurmoilSkill.CoreType.Ranged).stats(stats -> stats.threat(1)).abilities(MageAbilities.BOLT).build();
