...
public class MeleeSkills implements ITurmoilSkills {
	...
	public final TurmoilSkill CORE = builder("core").noDescription().core(TurmoilSkill.CoreType.Melee).stats(stats -> stats.threat(1)).abilities(MeleeAbilities.RUSH).texture(MeleeAbilities.RUSH.getTexture()).build();

	public final TurmoilSkill VOIDIC_BOND = generic("voidic_bond").required(CORE).stats(stats -> stats.voidicDamage(1).rechargeRate(1)).texture(GenericSkillIcons.VOIDIC_BOND).build();
	...
	public final TurmoilSkill BONDING_5 = generic("voidic_bonding_5").description("voidic_bonding").required(BONDING_4).stats(stats -> stats.rechargeRate(4)).texture(GenericSkillIcons.VOIDIC_BONDING).build();
	...
	public final TurmoilSkill EMPOWER_ATTACK_SLICING = builder("empower_attack_slicing").noDescription().abilities(MeleeAbilities.EMPOWER_ATTACK_SLICING).required(VOIDIC_FIGHTER_1).texture(MeleeAbilities.EMPOWER_ATTACK_SLICING.getTexture()).build();
	...
	public final TurmoilSkill CLEAVE = builder("cleave").noDescription().abilities(MeleeAbilities.CLEAVE).required(TEMPEST_1).texture(MeleeAbilities.CLEAVE.getTexture()).build();
	...
	public final TurmoilSkill EMPOWER_ATTACK_BLEED = builder("empower_attack_bleed").noDescription().abilities(MeleeAbilities.EMPOWER_ATTACK_BLEED).required(CHAOS_BLADE_1).texture(MeleeAbilities.EMPOWER_ATTACK_BLEED.getTexture()).build();
	public final TurmoilSkill SENSE_WEAKNESS = builder("sense_weakness").noDescription().abilities(MeleeAbilities.SENSE_WEAKNESS).required(CHAOS_BLADE_1).texture(MeleeAbilities.SENSE_WEAKNESS.getTexture()).build();
