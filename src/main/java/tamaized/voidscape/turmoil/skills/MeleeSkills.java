...
public class MeleeSkills implements ITurmoilSkills {
	...
	public final TurmoilSkill VOIDIC_FIGHTER_2 = builder("voidic_fighter_2").required(VOIDIC_FIGHTER_1).stats(stats -> stats.voidicDamage(1).voidicDamageReduction(1)).build();
	public final TurmoilSkill WAY_OF_THE_BLADE_2 = builder("way_of_the_blade_2").required(VOIDIC_FIGHTER_2, WAY_OF_THE_BLADE_1).stats(stats -> stats.voidicDamage(1)).build();
	public final TurmoilSkill EMPOWER_ATTACK_2X = builder("empower_attack_2x").required(VOIDIC_FIGHTER_2).build();
	public final TurmoilSkill VOIDIC_FIGHTER_3 = builder("voidic_fighter_3").required(VOIDIC_FIGHTER_2).stats(stats -> stats.voidicDamage(1).voidicDamageReduction(1)).build();
	public final TurmoilSkill WAY_OF_THE_BLADE_3 = builder("way_of_the_blade_3").required(VOIDIC_FIGHTER_3, WAY_OF_THE_BLADE_2).stats(stats -> stats.voidicDamage(1)).build();
	public final TurmoilSkill EMPOWER_ATTACK_LIFESTEAL = builder("empower_attack_lifesteal").required(VOIDIC_FIGHTER_3).build();
	public final TurmoilSkill VOIDIC_FIGHTER_4 = builder("voidic_fighter_4").required(VOIDIC_FIGHTER_3).stats(stats -> stats.voidicDamage(2).voidicDamageReduction(2)).build();
	public final TurmoilSkill WAY_OF_THE_BLADE_4 = builder("way_of_the_blade_4").required(VOIDIC_FIGHTER_4, WAY_OF_THE_BLADE_3).stats(stats -> stats.voidicDamage(2)).build();
	public final TurmoilSkill EMPOWER_ATTACK_3X = builder("empower_attack_3x").required(VOIDIC_FIGHTER_4).build();
	public final TurmoilSkill VOIDIC_FIGHTER_5 = builder("voidic_fighter_5").required(VOIDIC_FIGHTER_4).stats(stats -> stats.voidicDamage(5).voidicDamageReduction(5)).build();
	public final TurmoilSkill WAY_OF_THE_BLADE_5 = builder("way_of_the_blade_5").required(VOIDIC_FIGHTER_5, WAY_OF_THE_BLADE_4).stats(stats -> stats.voidicDamage(5)).build();
	public final TurmoilSkill BLITZ = builder("blitz").required(VOIDIC_FIGHTER_5).build();

	public final TurmoilSkill TEMPEST_1 = builder("tempest_1").required(CORE).stats(stats -> stats.voidicDamage(1)).build();
	public final TurmoilSkill DEFT_STRIKES_1 = builder("deft_strikes_1").required(TEMPEST_1).stats(stats -> stats.cooldown(1)).build();
	public final TurmoilSkill CLEAVE = builder("cleave").required(TEMPEST_1).build();
	public final TurmoilSkill TEMPEST_2 = builder("tempest_2").required(TEMPEST_1).stats(stats -> stats.voidicDamage(1)).build();
	public final TurmoilSkill DEFT_STRIKES_2 = builder("deft_strikes_2").required(TEMPEST_2).stats(stats -> stats.cooldown(1)).build();
	public final TurmoilSkill GREATER_CLEAVE = builder("greater_cleave").required(TEMPEST_2).build();
	public final TurmoilSkill TEMPEST_3 = builder("tempest_3").required(TEMPEST_2).stats(stats -> stats.voidicDamage(1)).build();
	public final TurmoilSkill DEFT_STRIKES_3 = builder("deft_strikes_3").required(TEMPEST_3).stats(stats -> stats.voidicDamage(1)).build();
	public final TurmoilSkill WHIRLWIND = builder("whirlwind").required(TEMPEST_3).build();
	public final TurmoilSkill TEMPEST_4 = builder("tempest_4").required(TEMPEST_3).stats(stats -> stats.voidicDamage(2)).build();
	public final TurmoilSkill DEFT_STRIKES_4 = builder("deft_strikes_4").required(TEMPEST_4).stats(stats -> stats.cooldown(2)).build();
	public final TurmoilSkill TWO_WEAPON_FIGHTING = builder("two_weapon_fighting").required(TEMPEST_4).build();
	public final TurmoilSkill TEMPEST_5 = builder("tempest_5").required(TEMPEST_4).stats(stats -> stats.voidicDamage(5)).build();
	public final TurmoilSkill DEFT_STRIKES_5 = builder("deft_strikes_5").required(TEMPEST_5).stats(stats -> stats.cooldown(5)).build();
	...
	public final TurmoilSkill CHAOS_BLADE_2 = builder("chaos_blade_2").required(CHAOS_BLADE_1).stats(stats -> stats.voidicDamage(1)).build();
	...
	public final TurmoilSkill CHAOS_BLADE_3 = builder("chaos_blade_3").required(CHAOS_BLADE_2).stats(stats -> stats.voidicDamage(1)).build();
	...
	public final TurmoilSkill CHAOS_BLADE_4 = builder("chaos_blade_4").required(CHAOS_BLADE_3).stats(stats -> stats.voidicDamage(2)).build();
	public final TurmoilSkill BLOODBATH = builder("bloodbath").required(CHAOS_BLADE_4).build();
	public final TurmoilSkill CHAOS_BLADE_5 = builder("chaos_blade_5").required(CHAOS_BLADE_4).stats(stats -> stats.voidicDamage(5)).build();
