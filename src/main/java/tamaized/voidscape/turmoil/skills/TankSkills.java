...
public class TankSkills implements ITurmoilSkills {
	...
	public final TurmoilSkill VOIDIC_DEFENDER_2 = builder("voidic_defender_2").required(VOIDIC_DEFENDER_1).stats(stats -> stats.voidicDamageReductionPercentage(1).hearts(1).threat(1)).build();
	...
	public final TurmoilSkill VOIDIC_DEFENDER_3 = builder("voidic_defender_3").required(VOIDIC_DEFENDER_2).stats(stats -> stats.voidicDamageReductionPercentage(1).hearts(1).threat(1)).build();
	...
	public final TurmoilSkill VOIDIC_DEFENDER_4 = builder("voidic_defender_4").required(VOIDIC_DEFENDER_3).stats(stats -> stats.voidicDamageReductionPercentage(2).hearts(2).threat(2)).build();
	...
	public final TurmoilSkill VOIDIC_DEFENDER_5 = builder("voidic_defender_5").required(VOIDIC_DEFENDER_4).stats(stats -> stats.voidicDamageReductionPercentage(5).hearts(5).threat(5)).build();
	...
	public final TurmoilSkill INSANE_BEAST_2 = builder("insane_beast_2").required(INSANE_BEAST_1).stats(stats -> stats.hearts(1)).build();
	...
	public final TurmoilSkill INSANE_BEAST_3 = builder("insane_beast_3").required(INSANE_BEAST_2).stats(stats -> stats.hearts(1)).build();
	...
	public final TurmoilSkill INSANE_BEAST_4 = builder("insane_beast_4").required(INSANE_BEAST_3).stats(stats -> stats.hearts(2)).build();
	public final TurmoilSkill FURY = builder("fury").required(INSANE_BEAST_4).build();
	public final TurmoilSkill INSANE_BEAST_5 = builder("insane_beast_5").required(INSANE_BEAST_4).stats(stats -> stats.hearts(5).healAmp(10)).build();
	...
	public final TurmoilSkill TACTICIAN_2 = builder("tactician_2").required(TACTICIAN_1).stats(stats -> stats.voidicDamage(1).voidicDamageReduction(1)).build();
	...
	public final TurmoilSkill TACTICIAN_3 = builder("tactician_3").required(TACTICIAN_2).stats(stats -> stats.voidicDamage(1).voidicDamageReduction(1)).build();
	...
	public final TurmoilSkill TACTICIAN_4 = builder("tactician_4").required(TACTICIAN_3).stats(stats -> stats.voidicDamage(2).voidicDamageReduction(2)).build();
	...
	public final TurmoilSkill TACTICIAN_5 = builder("tactician_5").required(TACTICIAN_4).stats(stats -> stats.voidicDamage(5).voidicDamageReduction(5)).build();
