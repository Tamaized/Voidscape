...
public class VoidChunkGenerator extends ChunkGenerator {
	...
	public static final Codec<VoidChunkGenerator> codec = RecordCodecBuilder.create((p_236091_0_) -> {
	...
	private final float[] field_222561_h = Util.make(new float[13824], (p_236094_0_) -> {
		for (int i = 0; i < 24; ++i) {
			for (int j = 0; j < 24; ++j) {
				for (int k = 0; k < 24; ++k) {
	...
	public VoidChunkGenerator(BiomeProvider p_i231903_1_, long seed, DimensionSettings p_i231903_4_) {
		this(p_i231903_1_, p_i231903_1_, seed, p_i231903_4_);
	}

	private VoidChunkGenerator(BiomeProvider biomeProvider1, BiomeProvider biomeProvider2, long seed, DimensionSettings dimensionSettings) {
		super(biomeProvider1, biomeProvider2, dimensionSettings.func_236108_a_(), seed);
		this.seed = seed;
		...
		this.horizontalNoiseGranularity = noisesettings.func_236174_e_() * 2; // EDIT, was 4
	...
	public ChunkGenerator func_230349_a_(long seed) {
		return new VoidChunkGenerator(this.biomeProvider.func_230320_a_(seed), seed, this.dimensionSettings);
	}

	public boolean func_236088_a_(long p_236088_1_, DimensionSettings.Preset p_236088_3_) {
		return this.seed == p_236088_1_ && this.dimensionSettings.func_236109_a_(p_236088_3_);
	}
	...
	private void makeBedrock(IChunk chunkIn, Random rand) {
		...
		int l = this.height - 1 - this.dimensionSettings.func_236117_e_();
		int i1 = 5;
	...
	private double func_222556_a(int p_222556_0_, int p_222556_1_, int p_222556_2_) {
	...
	private static double func_222554_b(int p_222554_0_, int p_222554_1_, int p_222554_2_) {
		...
		return d4 * d3; // Also a required edit
	}
	...
	public int func_230356_f_() {
		return this.dimensionSettings.func_236119_g_();
	}
	...
	public void func_230354_a_(WorldGenRegion p_230354_1_) {
		//		if (!this.field_236080_h_.func_236120_h_()) { // Disable Mob Gen
